...
public class InboxEndpoints {
  ...
  @Sql(executionPhase = ExecutionPhase.BEFORE_TEST_METHOD, statements = {
      ...
      "INSERT INTO inbox (id, receiver_id, message, is_read, sent_at) VALUES ('a2bb9999-894d-4afc-9f7d-b104be716347','c70a38f9-b770-4f2d-8c64-32cc583aac95', 'Test message 1', false, now())",
      "INSERT INTO inbox (id, receiver_id, message, is_read, sent_at) VALUES ('b2bb9999-894d-4afc-9f7d-b104be716347','c70a38f9-b770-4f2d-8c64-32cc583aac95', 'Test message 2', false, now())",
      "INSERT INTO inbox (id, receiver_id, message, is_read, sent_at) VALUES ('c2bb9999-894d-4afc-9f7d-b104be716347','c70a38f9-b770-4f2d-8c64-32cc583aac95', 'Test message 3', false, now())"
  })
  ...
  public void getAllMessages() throws Exception {
    ...
    Inbox message1 = inboxRepository.findByIdAndReceiver(UUID.fromString("a2bb9999-894d-4afc-9f7d-b104be716347"), account).orElseThrow();
    Inbox message2 = inboxRepository.findByIdAndReceiver(UUID.fromString("b2bb9999-894d-4afc-9f7d-b104be716347"), account).orElseThrow();
    Inbox message3 = inboxRepository.findByIdAndReceiver(UUID.fromString("c2bb9999-894d-4afc-9f7d-b104be716347"), account).orElseThrow();

    List<InboxGetAllResponseDTO> expectedResponseBody =
        Stream.of(message1, message2, message3)
            .map(msg -> new InboxGetAllResponseDTO(msg.getId(), msg.getMessage(), msg.getIsRead(), msg.getSentAt()))
            .toList();
  ...
  public void deleteMessageById() throws Exception {
    ...
    ResultActions deleteMessage = mockMvc.perform(MockMvcRequestBuilders.delete("/v1/inbox/d24b4a00-22f1-4ef2-a081-2c9b95f76156")
        .principal(()-> "usernameInbox"));

    deleteMessage.andExpect(status().isOk());

    Assertions.assertTrue(inboxRepository.findByIdAndReceiver(UUID.fromString("d24b4a00-22f1-4ef2-a081-2c9b95f76156"), account).isEmpty());
  }
}