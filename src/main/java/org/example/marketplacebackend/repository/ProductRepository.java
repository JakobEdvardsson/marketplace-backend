...
public interface ProductRepository extends JpaRepository<Product, UUID> {
  ...
  @EntityGraph(attributePaths = {"price", "productCategory"})
  @Query("""
  ...
  @EntityGraph(attributePaths = {"productCategory", "condition"})
  @Query("""
  ...
  @EntityGraph(attributePaths = {"condition", "price", "productCategory"})
  @Query("""
  ...
  @EntityGraph(attributePaths = {"productCategory", "condition", "price"})
  @Query("""
