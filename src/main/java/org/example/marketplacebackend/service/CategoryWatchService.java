...
@Service
public class CategoryWatchService {

  private static final Logger logger = LoggerFactory.getLogger(CategoryWatchService.class);

  private final ApplicationEventPublisher eventPublisher;

  CategoryWatchService(ApplicationEventPublisher eventPublisher) {
